...
| <a id="flutter.toolchain-flutter_version"></a>flutter_version |  Flutter version. Defaults to the newest integrity-verified stable release in the checked-in version table.   | String | optional |  `"3.47.0"`  |
